window.addEventListener('DOMContentLoaded', function () {
        ...
        render() {
            ...
            element.innerHTML = `
                ...
                <div class="menu_item-price">
                    <div class="menu__item-cost">чeнa:</div>
                    <div class="menu__item-total"><span>${this.price}</span> EUR/дeнь</div>
                </div>
            `;
    ...
    function showThanksModal(message) {
        const prevModalDialog = document.querySelector('.modal___dialog');
        ...
        thanksModal.innerHTML = `
            <div class="modal__content">
                ...
                <div class="modal___title">${message}</div>
            </div>
        `;
